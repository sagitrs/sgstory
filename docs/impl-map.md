...
> **状态**：v1.9（**M1 骨架 + M2–M4 文案 + M5 终局 + M6a–f 打磨 + M5c/M5d 花田 + M5e/M5f/M5g 口径已完成**）
...
| **M5g** | **藏杖任务 + 卷轴并入日记 + 光点收束**（canon 补正 #9）——新 `寻杖` 段落与 `family_favor` 好感门；删 `告知与告别`；日记/卷轴只在**现在**书房 | 六门 + 场景路线（含**双门槛**负例） | ✅ 本 PR |
...
src/
  ...
  50-ch3.twee         三章（坐标）：地下宴会厅 · 宴会·过去 · 观星者 · 当时的女巫 · 寻杖 · 老巫女 · 喂花 · 交付 · 唤醒 · 归位
...
| `family_favor` | 旅人替当时的女巫找回被藏起的杖 → 她才肯换哨 | 过去·寻杖 → 过去·当时的女巫 |

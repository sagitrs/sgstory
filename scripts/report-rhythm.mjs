...
export const THRESHOLDS = {
	...
	e4: {
		...
		//注意：**显式申报**（不是静默放宽）：`night-ferry` 的接入契约**没有情报面**（`pc.ev` 全程为空、
...
//注意：`#1004` B2b（换样本）：旧值 `['花田','龙战']` 是**旧故事**的首要不可逆点 → 按存活样本 `night-ferry`
